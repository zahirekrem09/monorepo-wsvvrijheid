...
export const TOPIC_MOCK: Topic = {
  ...
  link: 'https://boldmedya.com/2022/07/29/surgun-profesor-mehmet-atesin-hikayesi-teknigi-tip-literaturune-girdi-avrupada-kalp-cerrahligina-baslayacak/',
}
